...
namespace Prueba.Net.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_departamento,nombre_departamento,estado")] Departament departament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_departamento,nombre_departamento,estado")] Departament departament)
        {
            if (ModelState.IsValid)
            {
